...
*/
    ...
    ArrayList tempwordArray = new ArrayList();
    public void removeDuplicates(string message)
    {
        ...
        for (int i = 0; i < original.Length; i++)
        {
            ...
            {
                word += original.Substring(i, 1);
            }
        }
        Console.WriteLine("Original: " + original);
        Console.WriteLine("No duplicates: " + newMessage);
    ...
    private bool checkWord(string w)
    {
        ...
        for (int x = 0; x < tempwordArray.Count; x++)
        {
            if ((string)tempwordArray[x] == w)
            {
                return true;
            }
        }
    ...
    public void removeDuplicates2(string message)
    {
        string original = message + " ";
        string word = "";
        ...
        for (int z = 0; z < tempwordArray.Count; z++)
        {
            Console.Write(tempwordArray[z] + " ");
        }
    }
